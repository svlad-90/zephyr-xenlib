...
static int dom0less_init_domain(uint32_t domid, struct xen_domctl_getdomaininfo *infos)
{
	 ...
	 * In dom0less boot case the Xenstore event channel and ring page are already allocated by Xen.
	 * Dom0 retrieves these parameters to attach and initialize the Xenstore service.
	 */
